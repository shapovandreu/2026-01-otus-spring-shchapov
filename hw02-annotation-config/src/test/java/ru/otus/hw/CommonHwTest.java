...
@DisplayName("В задание должны соблюдены следующие требования")
class CommonHwTest {

    private static final String CONFIGURATION_ANNOTATION_NAME = "org.springframework.context.annotation.Configuration";

    @Test
    @DisplayName("Класс AppProperties не должен быть аннотирован аннотацией @Configuration")
    ...
    @Test
    @DisplayName("Класс AppProperties не должен быть аннотирован аннотацией @PropertySource")
    ...
    @Test
    @DisplayName("Все зависимости в бины должны внедряться через конструкторы")
